...
def main(): 
    directory_path = r'D:\Data\20250401_GCL007\part2\output\SLB_Raquel_oldBuffer'
...
def colocalize_tracks(dirpath):
    ...
    #             # get colocalizations
                df_colocs = coloc.coloc_tracks(df_locs_ch0, df_locs_ch1,leng = settings.min_len_track, max_distance=settings.th, n = settings.min_overlapped_frames)
