...
class RegistrationSettings:
    def __init__(self):
        ...
        self.x_coords_K2 = { #K2
            ...
            '561nm': (701, 701 + self.ch_width_K2),  
            '488nm': (1375, 1375 + self.ch_width_K2),
            '405nm': (1375, 1375 + self.ch_width_K2),
        }
        #Old K2 values, before alignment by Sebastian
        ...
        #K2
        self.ch_width_K2_tiff = 638   
        self.x_coords_K2_tiff = { #K2
            'l_ch': (21, 21 + self.ch_width_K2),  
            'm_ch': (701, 701 + self.ch_width_K2),  
            'r_ch': (1375, 1375 + self.ch_width_K2)
        }

        #K2 values before alignment by Sebastian
...
settings = Settings(RegistrationSettings, LocalizationSettings, LinkSettings, ColocTracksSettings, ColocLocsSettings)
#%%
